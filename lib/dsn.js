...
class DsnParser {
    dsnVersion = ['P22V01', 'P23V01', 'P24V01'];
    _societyList = [];
    _establishmentList = [];
    _dsnList = [];
    statementList = [];
    ...
    set contributionSlip(value) {
        this._contributionSlipList.push(value);
    }
    set societyList(value) {
        this._societyList.push(value);
    }
    set socialPaymentList(value) {
     ...
     */
    get dsn() {
        let dsnObject = this.makeDynamicObject(this._dsnList);
        return dsnObject;
    }
    /**
     * Retourne les informations de base de la DSN bloc S21.G00.22
     */
    get contributionSlip() {
        const contributionSlipList = [];
        for (let establishment of this.establishment) {
            ...
            let contributionSlipObject = this.makeDynamicObject(contributionSlipFilter);
    ...
    get socialPayment() {
        let socialPaymentObject = this.makeDynamicObject(this._socialPaymentList);
     ...
     */
    get society() {
        let societyObjet = this.makeDynamicObject(this._societyList);
        return societyObjet;
    }
    /**
